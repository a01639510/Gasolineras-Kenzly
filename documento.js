...
(function () {
  ...
  function build(ctx) {
    ...
    const FIG = (cap)  => B.push({ t:"fig", k:"instr", caption:cap });   // recuadro de imagen
    ...
    FIG("Logo de empresa");
    FIG("Foto / diseño relacionado al proyecto (portada)");
    ...
    FIG("Figura 1. Mapa de Unidad Ambiental Biofísica (UAB)");
    ...
    FIG("Figura 2. Mapa de UGA del Ordenamiento Ecológico Territorial estatal (SIGEIA)");
    ...
    FIG("Figura 3. Mapa del Programa de Ordenamiento Ecológico Local (POEL) del municipio");
    ...
    FIG("Figura 4. Mapa de macrolocalización (nivel nacional)");
    FIG("Figura 5. Mapa de localización (nivel estatal)");
    FIG("Figura 6. Mapa de localización (nivel municipal)");
    FIG("Figura 7. Mapa de microlocalización (predio del proyecto)");
    FIG("Figura 8. Evidencia fotográfica de colindancias");
    ...
    FIG("Figura 9. Plano arquitectónico / croquis del proyecto");
    ...
    FIG("Figura 10. Diagrama de flujo del proceso operativo");
    ...
    FIG("Figura 11. Hoja de seguridad de las sustancias (anexo)");
    ...
    FIG("Figura 12. Diagrama de entradas y flujos por etapa");
    ...
    FIG("Figura 13. Delimitación del Área de Influencia (AI)");
    ...
    FIG("Figura 15. Curvas de nivel y altitud (topografía)");
    FIG("Figura 16. Carta geológica");
    I("Edafología: tipos de suelo, textura, drenaje y vulnerabilidad a contaminación; profundidad y compactación.");
    FIG("Figura 17. Carta edafológica (tipos de suelo)");
    ...
    FIG("Figura 18. Mapa de hidrología superficial");
    ...
    FIG("Figura 19. Mapa de acuíferos / NDWI");
    ...
    FIG("Figura 20. Plano de cobertura vegetal del AI");
    FIG("Figura 21. Mapa de NDVI del AI");
    ...
    FIG("Figura 22. Evidencia fotográfica de flora/fauna identificada en el predio");
    ...
    FIG("Figura 23. Mapa de zonas de atención prioritaria");
    ...
    FIG("Figura 24. Análisis de cercanía a 2.0 km y receptores sensibles");
    ...
    FIG("Figura 25. Subsistemas e interacciones del Sistema Ambiental (diagrama de flujo)");
    if (state.incluirMEC !== false) {
      H(4, "Principios básicos del Modelo Ecológico Conceptual (MEC)");
      P(D.BOILER.mec);
      FIG("Figura 26. Componentes básicos de un MEC (Ogden et al., 2005)");
      FIG("Figura 27. Ejemplo de MEC parcial para el proyecto");
    }
    ...
    if (state.incluirMetodo !== false) {
      ...
      FIG("Figura 28. Diagrama de flujo de la metodología de evaluación de impacto");
    }
    ...
    FIG("Figura 29. Matriz de Leopold adaptada (anexo)");
    ...
    FIG("Figura 30. Matriz de resultados con cálculo de índices (anexo)");
    ...
    FIG("Figura 31. Plano general / cartografía del proyecto (anexo)");
